...
export function isOvenInterface(device: DeviceInterface): device is OvenInterface {
    return (device as OvenInterface).setTemperature !== undefined;
}

export function isIronInterface(device: DeviceInterface): device is IronInterface {
